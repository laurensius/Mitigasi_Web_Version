        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					...
					<span style="font-size: 11px;"><center><i>Note: Ingat2 password anda</i></center></span>
                </div> 
				</div>
    ...
    <div class="modal fade" id="delete_room2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">Deleting Grup...</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
					<h3><center>Apakah Anda yakin?</center></h3>
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
						...
						<select style="width:350px;" class="form-control" name="user">
							...
							include('../conn.php');
								...
								while($urow=mysqli_fetch_array($u)){
									?>
										<option value="<?php echo $urow['uid']; ?>"><?php echo $urow['nama']; ?></option>	
									<?php
								}
								}

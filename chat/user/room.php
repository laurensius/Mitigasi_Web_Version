		<div class="col-lg-8">
            <div class="panel panel-default" style="height:50px;">
				...
				<div class="showme hidden" style="position: absolute; left:-120px; top:20px;">
					<div class="well">
						<strong>Jumalh Anggota/s:</strong>
						<div style="height: 10px;"></div>
					<?php
						$rm=mysqli_query($conn,"select * from chat_member left join `user` on user.uid=chat_member.uid where chatroomid='$id'");
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['uid']==$_SESSION['id']){
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Home</a>
							<a href="#delete_room" data-toggle="modal" class="btn btn-danger">Delete Grup</a>
							<a href="#add_member" data-toggle="modal" class="btn btn-primary">Tambah Anggota</a>
							<?php
						}
						else{
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Home</a>
							<a href="#leave_room" data-toggle="modal" class="btn btn-warning">Keluar Grup</a>
							<?php
						}
					?>
				</div>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					<div style="height:10px;"></div>
					<span style="margin-left:10px;">Selamat datang di Grup </span><br>
				...
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Ketik pesan..." id="chat_msg">

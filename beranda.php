  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="active treeview">
          <a href="?mod=report_bencana">
            <i class="fa fa-user"></i> <span>Laporan Masyarakat</span>
      ...
      <!--  <li class="treeview">
         ...
         <li class="active treeview">
          <a href="chat/index.php">
            <i class="fa fa-commenting-o"></i> <span>Pesan Grup</span>

      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Peta Rawan Banjir</span>
               <a href="?mod=peta_rawan" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Peta Rawan Gunung Meletus</span>
               <a href="?mod=peta_rawan_gunung" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->

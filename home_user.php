        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Info Mitigasi</span>
               <a href="?mod=info_mitigasi" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Laporan Masyarakat</span>
               <a href="?mod=report_bencana" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Peta Kerawanan</span>
               <a href="?mod=peta_kerawanan" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Profil</span>
               <a href="?mod=profile" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
           </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a href="?mod=info_berita" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a href="chat/user/index.php" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->

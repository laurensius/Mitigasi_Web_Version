...
//============================
        ...
        if ($p_user != "" && $p_email != "") {
            ...
            if(($_FILES['file']['size'] >= $maxsize))
            {
                ...
                if (($_FILES['file']['size'] == 0) ){
                    ...
                    $q_edit1 = mysqli_query($mysqli, "UPDATE user SET nama='$p_user', email='$p_email', nohp='$p_nohp' where uid='$id_user'");
                    if ($q_edit1 > 0) {
                        echo "<div class='alert alert-block alert-success'><button type='button' class='close' data-dismiss='alert'><i class=''></i></button><strong><i class='fa fa-check'></i> BERHASIL!</strong> Data Profile Berhasil disimpan<br/></div>";
                    } else {
                    ...
                    $q_edit2 = mysqli_query($mysqli, "UPDATE user SET nama='$p_user', email='$p_email', nohp='$p_nohp' ,photo='$alamatfile' where uid='$id_user'");
                    if ($q_edit2 > 0) {
    ...
    $data = mysqli_fetch_array(mysqli_query($mysqli,"SELECT * FROM user WHERE uid=".$id_user));
...
<div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Update Data Profile</h3>            
            </div>      
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                if ($tb_act == "UBAH") {
                                    $q_edit_pass	= mysqli_query($mysqli,"UPDATE user SET pass= '$passmd5'
								WHERE uid = '$id_user'");
                                    if ($q_edit_pass) {
